    ...
    function window_tbl:new_page(cfg)
        ...
        function page_tbl:new_section(cfg)
            ...
            function section_tbl:new_toggle(cfg)
                ...
                local toggled = false;
                -- drawings
                local holder = utility.create("Square", {Parent = section_content, Visible = true, Transparency = 0, Size = UDim2.new(1,0,0,8), Thickness = 1, Filled = true, ZIndex = 6});
                --
    ...
    do
        local combat_main = combat:new_section_holder({name = "aim assist", size = "Fill"}) do
            local combat_assist = combat_main:new_section({name = 'main'}) do
                ...
                combat_assist:new_slider({name = "field of view (°)", flag = 'combat_assist_fov', min = 0, max = 1000, default = 500})
